# Cal AI — Push Notification Strategy
...
| CTA deep link | `calai://scan?meal=breakfast` |
| Badge | +1 |
| Sound | default |
...
| CTA deep link | `calai://scan?meal=lunch` |
| Badge | +1 |
| Sound | default |
...
| CTA deep link | `calai://scan?meal=dinner` |
| Badge | +1 |
| Sound | default |
...
| CTA deep link | `calai://paywall?source=push_scan_limit` |
| Badge | +1 |
| Sound | default |
